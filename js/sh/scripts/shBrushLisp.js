...
SyntaxHighlighter.brushes.Lisp = function(){
    ...
    var funcs     = 'lambda list progn mapcar car cdr reverse member append format define';
    var keywords  = 'let while unless cond if eq t nil defvar dotimes setf listp numberp not equal setq bind-keys';
    var macros    = 'mapc require loop when dolist dotimes defun';
    var operators = '> < + - = * / %';
